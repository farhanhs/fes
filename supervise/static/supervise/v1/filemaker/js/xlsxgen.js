//@ sourceMappingURL=XlsxGen.map
(function() {
  var DocXTemplater, XlsxGen, DocxQrCode, ImgReplacer, XmlTemplater, env, root,
    __slice = [].slice,
  ...
  DocUtils.loadDoc = function(path, noDocx, intelligentTagging, async, callback, basePath) {
    ...
    loadFile = function(data) {
      ...
      if (noDocx === false) {
        root.docX[fileName] = new XlsxGen(data, {}, intelligentTagging);
      }
      if (callback != null) {
        callback(false);
      }
  ...
  */
  ...
  root.XlsxGen = XlsxGen = (function() {
    var imageExtensions;

    imageExtensions = ['gif', 'jpeg', 'jpg', 'emf', 'png'];

    function XlsxGen(content, templateVars, intelligentTagging, qrCode, localImageCreator, finishedCallback) {
    ...
    XlsxGen.prototype.qrCodeCallBack = function(num, add) {
      var index;
    ...
    XlsxGen.prototype.testReady = function() {
    ...
    XlsxGen.prototype.load = function(content) {
      this.zip = new JSZip(content);
      return this.loadImageRels();
    };

    XlsxGen.prototype.loadImageRels = function() {
      var RidArray, content, tag;

      content = DocUtils.decode_utf8(this.zip.files["xl/_rels/workbook.xml.rels"].data);
    ...
    XlsxGen.prototype.addExtensionRels = function(contentType, extension) {
    ...
    XlsxGen.prototype.addImageRels = function(imageName, imageData) {
    ...
    XlsxGen.prototype.getImageByRid = function(rId) {
    ...
    XlsxGen.prototype.getImageList = function() {
    ...
    XlsxGen.prototype.setImage = function(path, data) {
      return this.zip.files[path].data = data;
    };

    XlsxGen.prototype.applyTemplateVars = function(templateVars, qrCodeCallback) {
    ...
    XlsxGen.prototype.getCsvVars = function() {
    ...
    XlsxGen.prototype.getCsvFile = function() {
      var file;
    ...
    XlsxGen.prototype.getTemplateVars = function() {
    ...
    XlsxGen.prototype.setTemplateVars = function(templateVars) {
      this.templateVars = templateVars;
      return this;
    };

    XlsxGen.prototype.output = function(download, name) {
      var result;
      if (download == null) {
        download = true;
      }
    ...
    XlsxGen.prototype.calcZip = function() {
      var file, index, zip;
    ...
    XlsxGen.prototype.getFullText = function(path, data) {
      var currentFile;
    ...
    XlsxGen.prototype.download = function(swfpath, imgpath, filename) {
      var output;
    ...
    function XmlTemplater(content, creator, templateVars, intelligentTagging, scopePath, usedTemplateVars, imageId, qrcodeCallback, localImageCreator) {
      ...
      if (this.qrcodeCallback === null) {
        this.qrcodeCallback = function() {
          return this.XlsxGen.ready = true;
        };
      }
      this.tagX = '';
      ...
      */
      ...
      if (creator instanceof XlsxGen || (creator == null)) {
        this.XlsxGen = creator;
      } else {
        options = creator;
        this.templateVars = options.templateVars;
        this.XlsxGen = options.XlsxGen;
  ...
  ImgReplacer = ImgReplacer = (function() {
    ...
    ImgReplacer.prototype.replaceImages = function() {
      ...
      callback = function(docxqrCode) {
        ...
        docxqrCode.xmlTemplater.XlsxGen.setImage("word/media/" + docxqrCode.imgName, docxqrCode.data);
        return docxqrCode.xmlTemplater.XlsxGen.qrCodeCallBack(docxqrCode.num, false);
      };
      ...
      for (u = _i = 0, _len = _ref.length; _i < _len; u = ++_i) {
        ...
        if (this.xmlTemplater.XlsxGen.qrCode) {
          ...
          if (tagrId !== void 0) {
            ...
            oldFile = this.xmlTemplater.XlsxGen.getImageByRid(rId);
            if (oldFile !== null) {
              ...
              if (tag !== void 0) {
                if (tag.getAttribute("name").substr(0, 6) !== "Copie_") {
                  ...
                  this.xmlTemplater.XlsxGen.qrCodeNumCallBack++;
                  this.xmlTemplater.XlsxGen.qrCodeCallBack(this.xmlTemplater.XlsxGen.qrCodeNumCallBack, true);
                  newId = this.xmlTemplater.XlsxGen.addImageRels(imgName, "");
                  this.xmlTemplater.imageId++;
                  this.xmlTemplater.XlsxGen.setImage("word/media/" + imgName, oldFile.data);
                  if (env === 'browser') {
                    qr[u] = new DocxQrCode(oldFile.data, this.xmlTemplater, imgName, this.xmlTemplater.XlsxGen.qrCodeNumCallBack);
                  }
                    ...
                    if (/\.png$/.test(oldFile.name)) {
                      _results.push((function(imgName) {
                        ...
                        finished = function(a) {
                          ...
                          try {
                            png.decoded = a;
                            qr[u] = new DocxQrCode(png, _this.xmlTemplater, imgName, _this.xmlTemplater.XlsxGen.qrCodeNumCallBack);
                            return qr[u].decode(callback);
                          } catch (_error) {
                            e = _error;
                            console.log(e);
                            return _this.xmlTemplater.XlsxGen.qrCodeCallBack(_this.xmlTemplater.XlsxGen.qrCodeNumCallBack, false);
                          }
                        };
                        return dat = png.decode(finished);
                      })(imgName));
                    } else {
                      _results.push(this.xmlTemplater.XlsxGen.qrCodeCallBack(this.xmlTemplater.XlsxGen.qrCodeNumCallBack, false));
                    }
                  }
                } else {
          ...
          if (this.xmlTemplater.currentScope["img"][u] != null) {
            ...
            if (this.xmlTemplater.XlsxGen == null) {
              throw 'XlsxGen not defined';
            }
            newId = this.xmlTemplater.XlsxGen.addImageRels(imgName, imgData);
            tag = xmlImg.getElementsByTagNameNS('*', 'docPr')[0];
            if (tag === void 0) {
              console.log('tag not defined, trying alternate method');
              tag = xmlImg.getElementsByTagName('wp:docPr')[0];
    ...
    DocxQrCode.prototype.searchImage = function() {
      ...
      if (this.result.substr(0, 4) === 'gen:') {
        return callback = function(data) {
          ...
          return _this.xmlTemplater.XlsxGen.localImageCreator(_this.result, callback);
        };
