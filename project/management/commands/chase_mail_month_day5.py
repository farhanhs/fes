    ...
    def handle(self, *args, **kw):
        ...
        for i in email_list:
            try:
                ...
                info += '<br><br>依據本署工程督導小組設置及作業要點第11點規定：當年度同一直轄市、縣(市)每月5日前未在本署遠端工程管理系統填報（更新）所執行相關工程累計至前１個月最新進度或填報不實資料者，每次記點１次，當年度累計逾3次者，次年度經費補助比例依「行政院農業部主管計畫補助基準」減少2％。<br><br>請各機關依時限確實填報。'
