...
(function() {
  ...
  */
  ...
  root.DocxGen = DocxGen = (function() {
    ...
    DocxGen.prototype.output = function(download, name, obj, text) {
      var result;
      if (download == null) {
        download = true;
      }
      ...
      if (download) {
        if (env === 'node') {
          ...
          obj.attr("href", "data:application/vnd.openxmlformats-officedocument.wordprocessingml.document;base64," + result);
          obj.attr("download", name);
          if(obj.children().length) {
            obj.children().attr("value", text);
  ...
  XmlTemplater = XmlTemplater = (function() {
    ...
    XmlTemplater.prototype.replaceCurly = function(newValue, content) {
      ...
      if (newValue != null) {
        newValue = newValue.replace(/\<\/?p ?\>/g, "");
        newValue = newValue.replace(/\<br ?\/?\>/g, "<w:br />");
      }
