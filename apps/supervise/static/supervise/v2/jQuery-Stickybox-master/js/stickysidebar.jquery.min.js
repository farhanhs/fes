(function(c){
    ...
    c.each(e,function(a,d){
        ...
        if(b){
            ...
            d.offset();
            var f=b.orig.offset.top-b.offs.top,h=f;
    ...
    if(a){
        var d=a.parent(),b=d.offset(),e=a.offset(),f=a.data("stickySB");
        for(f||(f={
            offs:{},
            orig:{
                top:a.css("top"),
            ...
            });b&&"top"in b&&d.css("position")=="static";)d=d.parent(),
        b=d.offset();
    if(b){
        var h=parseInt(d.css("paddingBottom")),h=isNaN(h)?0:h;
        f.offs=b;
